...
public class KeyBindingHandler {
    public static final KeyMapping TOGGLE_PLAQUES_KEY_MAPPING = KeyMappingHelper.registerUnboundKeyMapping(MobPlaques.id(
            "toggle_plaques"));
    ...
    public static final String KEY_MOB_PLAQUES_STATUS = TOGGLE_PLAQUES_KEY_MAPPING.getName() + ".message";
